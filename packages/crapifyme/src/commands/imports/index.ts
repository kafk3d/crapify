...
export const importsCommand = new Command('imports')
	...
	.option('--sort', 'Sort imports alphabetically', false)
	.option('--group', 'Group imports by type (external, internal, relative)', false)
	.option('--remove-unused', 'Remove unused imports via AST analysis', false)
	.option('--merge-duplicates', 'Merge duplicate imports from same source', false)
